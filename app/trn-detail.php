      ...
      while($d = mysqli_fetch_array($data)){
        ...
        <table class="table table-bordered">
          <tbody>
            ...
            <?php 
            $data = mysqli_query($koneksi,
              "SELECT lab_tarif.nama, lab_tarif.nilai_normal, lab_tarif.satuan, lab_trn_hasil.hasil_uji, lab_sampel.nama_sampel, lab_trn_hasil.id_lab_trn_hasil
              FROM lab_tarif
            ...
            while($d = mysqli_fetch_array($data)){
              ...
              "<td align='center'>".$d['nama_sampel']."<a href='trn-detail-hapus.php?id=".$d['id_lab_trn_hasil']."&no=".$id_lab_trn."'>&nbsp;&nbsp;&nbsp;<u>hapus</u></a></td>".
              "</tr>";
            }
            ?>
          </tbody>
