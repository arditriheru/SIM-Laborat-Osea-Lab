         ...
         setTimeout(function() {
          swal({
            ...
            type: 'error'
              ...
              $simpan=mysqli_query($koneksi,"INSERT INTO lab_trn (id_lab_trn, id_mr_pendaftaran, id_petugas, pemeriksaan, dx, tanggal, jam, total_bayar, status_bayar,selesai)VALUES('','$id_mr_pendaftaran','$id_petugas','$data','$dx','$tanggalsekarang','$jamsekarang','$total','0','0')");
