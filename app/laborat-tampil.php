...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h1>Laboratorium <small><?php include "../config/date-time.php";?></small></h1>
      <ol class="breadcrumb">
              ...
              <tbody>
                ...
                while($d = mysqli_fetch_array($data)){
                  ...
                  <tr>
                    ...
                    <?php
                    if($d['status_bayar']=='1'){ ?>
                      <td><center><a href="trn-detail.php?id=<?php echo $d['id_lab_trn']; ?>"
                        <button type="button" class="btn btn-success"><i class='fa fa-edit'></i></button></a></center></td>
                      <?php }else{ ?><td></td><?php } ?>
                      </tr><?php } ?>
                    </tbody>
                  </table>
